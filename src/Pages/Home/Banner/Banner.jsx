...
const Banner = () => {
    return (
        <section className="w-full bg-gray-50">
            ...
            >
                ...
                >
                    ...
                    <div className="lg:w-1/2 text-center lg:text-left animate__animated animate__fadeInLeft flex flex-col">
                        <h1 className="text-4xl md:text-4xl lg:text-5xl cinzel-font font-bold text-gray-800 leading-snug">
                        ...
                        <div className="mt-6 flex justify-center lg:justify-start gap-4">
                            ...
                            <button className="px-6 py-3 text-[#5b21b6] bg-white hover:bg-gray-100 border border-[#5b21b6] rounded-lg shadow-md text-sm md:text-base font-semibold">
                                Review Plans
                            </button>
                        </div>
                    </div>
            ...
            {/* Bottom Section */}
            <div className="mt-12 py-8 border-t-2 border-gray-300 border-b-2">
                <div className="md:w-[80%] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex gap-5 animate__animated animate__fadeInUp px-12 py-5">
                        <LuPlane size={55} className="text-[#5b21b6] text-4xl mb-3" />
                        <div>
                            <h3 className="text-3xl font-bold text-[#2a00a2] mb-4">23,973</h3>
                    ...
                    {/* Card 2 */}
                    <div className="flex gap-5 animate__animated animate__fadeInUp border-t-2 border-b-2 sm:border-t-0 sm:border-b-0 sm:border-l-2 sm:border-r-2 border-gray-200 py-5 px-12">

                        <GiWorld size={55} className="text-[#5b21b6] text-4xl mb-3" />
                        <div>
                            <h3 className="text-3xl font-bold text-[#2a00a2] mb-4">82,000</h3>
                            <p className="text-sm text-gray-600 md:w-[90%]">
