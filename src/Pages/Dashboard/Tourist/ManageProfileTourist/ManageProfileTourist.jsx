                    ...
                    <div className="flex-1 mt-6 md:mt-0 md:ml-6 dark:text-white">
                        ...
                        <div className='flex gap-3'>
                            ...
                            <Link to={`/dashboard/tourist/join-guide`}>
                                <button className='bg-orange-500 px-7 py-2 hover:bg-white transition-all duration-500 hover:text-black rounded-xl text-white font-bold'>Apply For Tour Guide</button>
                            </Link>
                        </div>
